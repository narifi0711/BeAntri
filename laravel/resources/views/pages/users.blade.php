...
@section('subcontent')
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <button id="btn-add-user" class="btn btn-primary shadow-md">
    ...
    <div class="intro-y box p-5 mt-5">
        ...
        <div class="overflow-x-auto scrollbar-hidden">
            <div id="tbl-user" class="mt-5 table-report table-report--tabulator"></div>
        </div>
    </div>
    <!-- END: HTML Table Data -->
    <!-- BEGIN: User Modal -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto" id="user-modal-title">Add User</h2>
                </div>
                <form id="user-form" data-store-url="{{ route('users.store') }}">
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                        ...
                        <div class="col-span-12">
                            ...
                            <div class="text-danger mt-2" id="error-name"></div>
                        </div>
                        <div class="col-span-12">
                            <label for="email" class="form-label">Email</label>
                            <input id="email" type="email" name="email" class="form-control"
                                placeholder="Email ecampus" required>
                        ...
                        <div class="col-span-12">
                            ...
                            <div class="text-danger mt-2" id="error-role"></div>
                        </div>
                        <div class="col-span-12">
                            <label for="password" class="form-label">Password</label>
                            <input id="password" type="password" name="password" class="form-control"
                                placeholder="********">
                            <div class="text-slate-500 text-xs mt-1" id="password-hint">Leave blank to keep current
                                password.</div>
                            <div class="text-danger mt-2" id="error-password"></div>
                        </div>
                        <div class="col-span-12">
